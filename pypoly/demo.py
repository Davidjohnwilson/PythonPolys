...
print("We have some basic solving functionalities available in the       ")
print("package. We can numerically solve polynomials up to degree 3 using")
print("the numeric_solve_poly function.")
print("   > f = SparsePoly([[0, 1], [1, -5]])                            ")
f = SparsePoly([[0, 1], [1, -5]])
print("   > f.print_poly()                                               ")
print("              " + f.print_poly())
print("   > f.numeric_solve_poly()                                       ")
print("              " + str(f.numeric_solve_poly()))
print("   > f = SparsePoly([[0, -1], [1, 1], [2, 1]])                    ")
f = SparsePoly([[0, -1], [1, 1], [2, 1]])
print("   > f.print_poly()                                               ")
print("              " + f.print_poly())
print("   > f.numeric_solve_poly()                                       ")
print("              " + str(f.numeric_solve_poly()))
...
print("We can also symbolically solve polynomials up to degree 2. This ")
print("uses the symbolic_solve_poly function.")

print("   > f = SparsePoly([[0, 1], [1, -5]])                            ")
f = SparsePoly([[0, 1], [1, -5]])
print("   > f.print_poly()                                               ")
print("              " + f.print_poly())
print("   > f.symbolic_solve_poly()                                      ")
print("              " + str(f.symbolic_solve_poly()))
print("   > f = SparsePoly([[0, -1], [1, 1], [2, 1]])                    ")
f = SparsePoly([[0, -1], [1, 1], [2, 1]])
print("   > f.print_poly()                                               ")
print("              " + f.print_poly()) 
print("   > f.symbolic_solve_poly()                                      ")
a = f.symbolic_solve_poly()
print("              [" + str(a[0]) + "]")

press_enter()

print("That's the end of the demo! I hope you find the package interesting")
print("and useful. If you have any comments or suggestions please feel    ")
print("free to contact me on developer[at]davidjw.co.uk.                  ")
print(blank_line)
print("        (C) David John Wilson, 2016                                ")
print(full_line)
